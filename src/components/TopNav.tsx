...
export default async function TopNav({ isAdmin = false }: TopNavProps) {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/10 dark:border-white/5 bg-background/60 backdrop-blur-xl supports-backdrop-filter:bg-background/40 shadow-sm dark:shadow-none">
            ...
            <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-foreground/10 text-foreground border border-foreground/20">
              <div className="w-9 h-9 bg-black dark:bg-white rounded-lg flex items-center justify-center shrink-0 p-2 transition-colors">
                ...
                >
                  ...
                  />
                  <path
                    d="M7 7h2v6H7zM11 9h2v4h-2zM15 6h2v7h-2z"
                    fill="currentColor"
                  />
                </svg>
              </div>
